...
SWIFT_EXTERN void GKLocalPlayer_FetchItems(void * _Nonnull pointer, int64_t taskId, void (* _Nonnull onSuccess)(int64_t, NSUInteger, uint8_t * _Nonnull, int32_t, uint8_t * _Nonnull, int32_t, uint8_t * _Nonnull, int32_t), void (* _Nonnull onError)(int64_t, void * _Nonnull));
